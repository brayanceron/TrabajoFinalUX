...
<body>
    ...
    foreach ($_FILES["mas_archivos"]['tmp_name'] as $key => $tmp_name) {
        if ($_FILES["mas_archivos"]["name"][$key]) {
            $filename = $_FILES["mas_archivos"]["name"][$key];
            $source = $_FILES["mas_archivos"]["tmp_name"][$key];
            ...
            if (move_uploaded_file($source, $target_path)) {
                ...
                $sql = 'INSERT INTO actividades(id_actividad,nombre_actividad,descripcion_actividad,id_terapia,multimedia) VALUES("' . $id_actividad . '","' . $nombre_actividad . '","' . $descripcion_Actividad . '","' . $id_terapia . '","' . $target_path . '");';
